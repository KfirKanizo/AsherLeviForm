...
פיצוי על אשפוז מעל 3 ימים ועד 30 יום (200 ש"ח ליום)<br>
נכות מתאונה<br>
מוות מתאונה<br>
...
שבר תאונת טלוויזיה (עד 5,000 ש"ח), מחשבים, מערכות אודיו/וידאו<br>
קלקול תכולת מקררים בעקבות שריפה (עד 5,000 ש"ח)<br>
...
ניתן להרחיב את הכיסוי ומשך הזמן
  `.trim(),
  "ביטוח מורחב": "הביטוח מורחב כולל כיסוי לשבר או אובדן של משקפי ראיה של המבוטח, בעל הגן ועובדי הגן המועסקים על ידי המבוטח, בשטח הגן. לא תעלה על סך 2000 ₪ ולא יותר מ- 5,000 ₪ לכל תקופת הביטוח. סעיף זה כפוף להשתתפות עצמית של 200 ₪ "
};
...
function calculatePremium() {
  ...
  if ([3, 4, 5, 6, 7].includes(track)) {
    if (track === 3) {
      ...
      // מסלול 7: עד 12 ילדים (כולל) = 1400 ₪ קבוע; החל מ-13 ילדים התעריף הקבוע מתבטל
      // ומחושבים כל הילדים × 120 ₪ (עם הנחת מועדון: ×110 ₪ לילד, באמצעות הנחת ×10 לילד בשלב ההנחות)
      basePremium = childrenCountValue <= 12 ? 1400 : childrenCountValue * 120;
    } else {
